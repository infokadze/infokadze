...
- I develop iOS apps using MVVM + Coordinator + DI pattern along with following APIs: UIKit, Combine, CombineCocoa, Foundation, PencilKit, HealthKit, Keychain, MongoDB (RealmSwift, Atlas Flexible Sync), Firebase, XCTest.
