...
- I develop iOS apps using MVVM + Coordinator + DI pattern along with following APIs: UIKit, Combine, Foundation, HealthKit, Keychain, MongoDB (RealmSwift, Atlas Flexible Sync), Firebase, XCTest.
